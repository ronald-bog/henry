...
function multiplicarArgumentos() {
   ...
   return 0;
   else return Array.from(arguments).reduce((num, ant) => num * ant);   
}
...
function mesesDelAño(array) {
   ...
   array.forEach((num) => {if (meses.includes(num)) nuevo.push(num);else nuevo.push('no esta');});
   if(nuevo.includes('no esta'))
...
function mayorACien(array) {
   ...
   // Tu código:
   let nuevo =[];
   array.forEach( (num) => { if(num>100) nuevo.push(num) } );
   return nuevo;
}
