...
function crearClaseMascota() {
  class Mascota {
    ...
    addActividad(actividad, frecuencia) {
      ...
      // Tu código aca:
      let objeto = { 'actividad': actividad, 'frecuencia': frecuencia};
      this.actividades.push(objeto);
    }
    ...
    getActividades() {
      ...
      // Tu código aca:
      let values = this.actividades.map(item => item.actividad);
     return values;
    }
    ...
    getFrecuencia(actividad) {
      ...
      // Tu código aca:
      return this.actividades.find(busqueda => busqueda.actividad === actividad).frecuencia;
    }
  }
